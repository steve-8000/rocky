...
```python
from amaze_rpc import RpcClient
...
```python
from amaze_rpc import MessageUpdateEvent, RpcClient
...
from amaze_rpc import RpcClient, host_tool
...
```python
from amaze_rpc import assistant_text, assistant_text_with_thinking
