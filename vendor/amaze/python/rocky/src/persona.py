...
from rocky.sandbox import Workspace
...
def _load(name: str) -> str:
    return resources.files("rocky.prompts").joinpath(name).read_text(encoding="utf-8")
...
def dirty_state_reminder(
    *,
    ...
    leaves changes behind that rocky would otherwise discard. The summary
