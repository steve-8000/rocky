"""Host tools exposed to the agent through `amaze_rpc.host_tool`.
...
from amaze_rpc import HostTool, HostToolContext, RpcCommandError, host_tool

from rocky import persona
from rocky.config import Settings
from rocky.db import Database, issue_key
from rocky.git_ops import GitCommandError, HeadDriftError
