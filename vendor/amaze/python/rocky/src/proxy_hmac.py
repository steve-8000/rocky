"""Shared HMAC signing/verification for the rocky ↔ gh-proxy channel.

Rocky signs every request to gh-proxy with an HMAC-SHA256 over
...
# Headers on every rocky→gh-proxy request.
HEADER_TIMESTAMP = "X-Rocky-Timestamp"  # unix seconds, integer string
HEADER_SIGNATURE = "X-Rocky-Sig"  # hex-encoded HMAC-SHA256
