"""Client half of the rocky ↔ gh-proxy channel.
...
routing clone/fetch/push through the proxy too — rocky never holds the PAT.
...
from rocky.git_ops import GitCommandError, HeadDriftError, PushResult
...
class GitHubProxyClient:
    """HMAC-signed REST client speaking to a `rocky.proxy.server` instance.
