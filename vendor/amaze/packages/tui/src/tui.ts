...
import { $flag, getDebugLogPath } from "@amaze/utils";
...
export class TUI extends Container {
	...
	#showHardwareCursor = $flag("AMAZE_HARDWARE_CURSOR");
	#clearOnShrink = $flag("AMAZE_CLEAR_ON_SHRINK"); // Clear empty rows when content shrinks (default: off)
	...
	#doRender(): void {
		...
		const debugRedraw = $flag("AMAZE_DEBUG_REDRAW");
		...
		// Configurable via setClearOnShrink() or AMAZE_CLEAR_ON_SHRINK=0 env var
