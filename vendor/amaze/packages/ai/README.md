...
```bash
npm install @amaze/ai
```

## Quick Start

```typescript
import { z, getModel, stream, complete, Context, Tool } from "@amaze/ai";
...
```typescript
import { stream, validateToolCall, Tool } from "@amaze/ai";
...
```typescript
import * as fs from "node:fs";
import { getModel, complete } from "@amaze/ai";
...
```typescript
import { getModel, streamSimple, completeSimple } from "@amaze/ai";
...
```typescript
import { getModel, stream } from "@amaze/ai";
...
```typescript
import { getProviders, getModels, getModel } from "@amaze/ai";
...
```typescript
import { Model, stream } from "@amaze/ai";
...
```typescript
import { getModel, complete, Context } from "@amaze/ai";
...
```typescript
import { Context, getModel, complete } from "@amaze/ai";
...
```typescript
import { getEnvApiKey } from "@amaze/ai";
...
```bash
bunx @amaze/ai login              # interactive provider selection
bunx @amaze/ai login anthropic    # login to specific provider
bunx @amaze/ai login vllm         # store vLLM API key (or placeholder for local no-auth)
bunx @amaze/ai list               # list available providers
```
...
```typescript
import { loginGitHubCopilot } from "@amaze/ai";
import * as fs from "node:fs";
...
```typescript
import { getModel, complete, getOAuthApiKey } from "@amaze/ai";
import * as fs from "node:fs";
