import type { ServerSentEvent } from "@amaze/utils";
...
function isSseResponse(response: Response): boolean {
	...
	// google-shared, google-gemini-cli, openai-codex-responses, amaze-native-client,
 ...
 *
 * Field parsing intentionally mirrors `readSseEvents` in `@amaze/utils`
