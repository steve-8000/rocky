...
import { $env, $pickenv, extractHttpStatusFromError } from "@amaze/utils";
...
import { streamAmazeNative } from "./providers/amaze-native-client";
...
export function streamSimple<TApi extends Api>(
	...
	// amaze-native transport.
	if (model.transport === "amaze-native") {
		return streamAmazeNative(model, context, options);
	}
...
const ANTHROPIC_USE_INTERLEAVED_THINKING = Bun.env.AMAZE_NO_INTERLEAVED_THINKING !== "1";
