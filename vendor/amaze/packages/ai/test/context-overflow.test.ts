...
import { complete } from "@amaze/ai/stream";
import type { AssistantMessage, Context, Model, Usage } from "@amaze/ai/types";
import { isContextOverflow } from "@amaze/ai/utils/overflow";
import { $which } from "@amaze/utils";
...
describe("Context overflow error handling", () => {
	...
	// Ollama tests require AMAZE_LOCAL_LLM=1 and ollama installed
	const ollamaInstalled = !!Bun.env.AMAZE_LOCAL_LLM && !!$which("ollama");
