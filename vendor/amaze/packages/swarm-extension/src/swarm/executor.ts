/**
 * Swarm agent execution via amaze's subagent infrastructure.
 *
...
import { runSubprocess } from "@amaze/coding-agent";
...
/**
 * Execute a single swarm agent as an amaze subagent.
 *
 * The agent receives:
