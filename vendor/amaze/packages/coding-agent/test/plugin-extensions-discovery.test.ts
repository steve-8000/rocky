...
import { discoverAndLoadExtensions } from "@amaze/coding-agent/extensibility/extensions/loader";
import { getAgentDir, getPluginsDir, setAgentDir, TempDir } from "@amaze/utils";

const currentPiCodingAgentPath = Bun.resolveSync("@amaze/coding-agent", import.meta.dir);
const currentPiExtensionsPath = Bun.resolveSync("@amaze/coding-agent/extensibility/extensions", import.meta.dir);
...
describe("plugin extension discovery", () => {
	...
	beforeEach(() => {
		...
		fs.mkdirSync(path.join(tempXdgDataHome, "amaze"), { recursive: true });
