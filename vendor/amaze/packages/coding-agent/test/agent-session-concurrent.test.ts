...
import { Agent, AgentBusyError, type AgentTool } from "@amaze/agent-core";
import { type AssistantMessage, getBundledModel, type Message, type ToolCall } from "@amaze/ai";
...
import type { Rule } from "@amaze/coding-agent/capability/rule";
...
import { TtsrManager } from "@amaze/coding-agent/export/ttsr";
...
describe("AgentSession concurrent prompt guard", () => {
	...
	// already processing` from amaze-rpc clients (rocky triage reminder path).
