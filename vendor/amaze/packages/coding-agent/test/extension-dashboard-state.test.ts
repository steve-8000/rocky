...
import { applyDisabledExtensionsToState } from "@amaze/coding-agent/modes/components/extensions/state-manager";
import type { DashboardState, Extension } from "@amaze/coding-agent/modes/components/extensions/types";
