...
import type { ModelRegistry, ProviderDiscoveryState } from "@amaze/coding-agent/config/model-registry";
import { ModelRegistry as ModelRegistryImpl } from "@amaze/coding-agent/config/model-registry";
