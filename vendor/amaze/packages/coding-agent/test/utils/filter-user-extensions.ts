...
import { getAgentDir, getConfigRootDir, getPluginsDir } from "@amaze/utils";
...
// 2. `getAgentDir()` (`~/.amaze/agent` or `$AMAZE_CODING_AGENT_DIR`)
//    Handles `AMAZE_CODING_AGENT_DIR` overrides that relocate the agent dir
