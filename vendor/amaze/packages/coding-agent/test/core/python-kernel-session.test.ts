...
import { disposeAllKernelSessions, executePython } from "@amaze/coding-agent/eval/py/executor";
import type {
	KernelExecuteOptions,
	KernelExecuteResult,
	KernelShutdownResult,
} from "@amaze/coding-agent/eval/py/kernel";
...
describe("executePython kernel reuse", () => {
	...
	beforeEach(() => {
		Bun.env.AMAZE_PYTHON_SKIP_CHECK = "1";
		startCalls = 0;
		kernels = [];
