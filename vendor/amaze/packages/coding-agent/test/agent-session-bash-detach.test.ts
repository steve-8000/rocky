 ...
 * verified at the unit level by `natives::shell::tests::child_session_action`
 ...
 *         → BashTool.execute
 *           → executeBash
 *             → natives `Shell.run` (real native binding)
...
import { createMockModel, type MockResponse } from "@amaze/ai/providers/mock";
...
import { BashTool, type ToolSession } from "@amaze/coding-agent/tools";
