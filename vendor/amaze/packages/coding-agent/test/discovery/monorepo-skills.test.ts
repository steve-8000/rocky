...
import { clearCache } from "@amaze/coding-agent/capability/fs";
import type { Skill } from "@amaze/coding-agent/capability/skill";
import type { LoadContext, LoadResult } from "@amaze/coding-agent/capability/types";
import { scanSkillsFromDir } from "@amaze/coding-agent/discovery/helpers";
...
describe("monorepo skill discovery", () => {
	...
	beforeEach(() => {
		clearCache();
		tempDir = fs.mkdtempSync(path.join(os.tmpdir(), "amazerepo-skills-"));
