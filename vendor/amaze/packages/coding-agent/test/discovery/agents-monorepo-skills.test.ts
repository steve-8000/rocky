...
import { clearCache, readFile } from "@amaze/coding-agent/capability/fs";
import type { Rule } from "@amaze/coding-agent/capability/rule";
import type { LoadContext } from "@amaze/coding-agent/capability/types";
import { getProjectPathCandidates } from "@amaze/coding-agent/discovery/agents";
import {
...
describe("agents provider project-level discovery", () => {
	...
	describe("skills", () => {
		...
		test("project walk-up skips home directory (no repo root)", async () => {
			// Regression for https://github.com/can1357/amaze/issues/1116:
