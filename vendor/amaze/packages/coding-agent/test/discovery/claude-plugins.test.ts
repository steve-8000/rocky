...
import { loadCapability } from "@amaze/coding-agent/capability";
import { clearCache as clearFsCache } from "@amaze/coding-agent/capability/fs";
import {
	clearClaudePluginRootsCache,
	listClaudePluginRoots,
	parseClaudePluginsRegistry,
} from "@amaze/coding-agent/discovery/helpers";
import { discoverAgents } from "@amaze/coding-agent/task/discovery";
import "@amaze/coding-agent/discovery/claude-plugins";
import type { Skill } from "@amaze/coding-agent/capability/skill";
import type { SlashCommand } from "@amaze/coding-agent/capability/slash-command";
