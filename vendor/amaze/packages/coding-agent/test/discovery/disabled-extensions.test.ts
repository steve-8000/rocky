...
import { type ContextFile, contextFileCapability } from "@amaze/coding-agent/capability/context-file";
import { resetSettingsForTest, Settings } from "@amaze/coding-agent/config/settings";
import { initializeWithSettings, loadCapability } from "@amaze/coding-agent/discovery";
