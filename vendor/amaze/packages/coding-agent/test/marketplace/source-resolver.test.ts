...
import type { MarketplacePluginEntry } from "@amaze/coding-agent/extensibility/plugins/marketplace";
import { resolvePluginSource } from "@amaze/coding-agent/extensibility/plugins/marketplace";
