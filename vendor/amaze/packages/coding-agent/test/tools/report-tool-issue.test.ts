...
import { __resetAutoQaFlushStateForTests, flushGrievances } from "@amaze/coding-agent/tools/report-tool-issue";
...
function pushSettings(overrides: Record<string, unknown> = {}): Settings {
	return Settings.isolated({
		...
		// gates on (or `AMAZE_AUTO_QA_PUSH=1` for headless overrides).
