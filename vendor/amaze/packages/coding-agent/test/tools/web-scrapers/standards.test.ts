...
import { handleCheatSh } from "@amaze/coding-agent/web/scrapers/cheatsh";
import { handleRfc } from "@amaze/coding-agent/web/scrapers/rfc";
import { handleTldr } from "@amaze/coding-agent/web/scrapers/tldr";
