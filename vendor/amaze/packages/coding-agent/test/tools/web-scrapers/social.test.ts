...
import { handleReddit } from "@amaze/coding-agent/web/scrapers/reddit";
import { handleStackOverflow } from "@amaze/coding-agent/web/scrapers/stackoverflow";
import { handleTwitter } from "@amaze/coding-agent/web/scrapers/twitter";
