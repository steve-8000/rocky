...
import { handleAur } from "@amaze/coding-agent/web/scrapers/aur";
import { handleBrew } from "@amaze/coding-agent/web/scrapers/brew";
import { handleMaven } from "@amaze/coding-agent/web/scrapers/maven";
import { handleNuGet } from "@amaze/coding-agent/web/scrapers/nuget";
import { handlePackagist } from "@amaze/coding-agent/web/scrapers/packagist";
import { handleRubyGems } from "@amaze/coding-agent/web/scrapers/rubygems";
