...
import { handleHuggingFace } from "@amaze/coding-agent/web/scrapers/huggingface";
import { handleSpotify } from "@amaze/coding-agent/web/scrapers/spotify";
import { handleVimeo } from "@amaze/coding-agent/web/scrapers/vimeo";
