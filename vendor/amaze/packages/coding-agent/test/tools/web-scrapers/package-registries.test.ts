...
import { handleCratesIo } from "@amaze/coding-agent/web/scrapers/crates-io";
import { handleGoPkg } from "@amaze/coding-agent/web/scrapers/go-pkg";
import { handleHex } from "@amaze/coding-agent/web/scrapers/hex";
import { handleNpm } from "@amaze/coding-agent/web/scrapers/npm";
import { handlePubDev } from "@amaze/coding-agent/web/scrapers/pub-dev";
import { handlePyPI } from "@amaze/coding-agent/web/scrapers/pypi";
