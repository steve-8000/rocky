...
import { handleBiorxiv } from "@amaze/coding-agent/web/scrapers/biorxiv";
import { handleOpenLibrary } from "@amaze/coding-agent/web/scrapers/openlibrary";
import { handleWikidata } from "@amaze/coding-agent/web/scrapers/wikidata";
