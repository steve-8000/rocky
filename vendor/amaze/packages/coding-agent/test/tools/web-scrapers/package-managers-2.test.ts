...
import { handleChocolatey } from "@amaze/coding-agent/web/scrapers/chocolatey";
import { handleDockerHub } from "@amaze/coding-agent/web/scrapers/dockerhub";
import { handleHackage } from "@amaze/coding-agent/web/scrapers/hackage";
import { handleMetaCPAN } from "@amaze/coding-agent/web/scrapers/metacpan";
import { handleRepology } from "@amaze/coding-agent/web/scrapers/repology";
import { handleTerraform } from "@amaze/coding-agent/web/scrapers/terraform";
