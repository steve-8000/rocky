...
import { handleMDN } from "@amaze/coding-agent/web/scrapers/mdn";
import { handleReadTheDocs } from "@amaze/coding-agent/web/scrapers/readthedocs";
...
describe.skipIf(SKIP)("handleReadTheDocs", () => {
	...
	it("returns null for non-readthedocs sites", async () => {
		...
		expect(await handleReadTheDocs("https://amazep.pypa.io/en/stable/", 20)).toBeNull();
	});
