...
import { handleArxiv } from "@amaze/coding-agent/web/scrapers/arxiv";
import { handleIacr } from "@amaze/coding-agent/web/scrapers/iacr";
import { handlePubMed } from "@amaze/coding-agent/web/scrapers/pubmed";
import { handleSemanticScholar } from "@amaze/coding-agent/web/scrapers/semantic-scholar";
import type { RenderResult } from "@amaze/coding-agent/web/scrapers/types";
