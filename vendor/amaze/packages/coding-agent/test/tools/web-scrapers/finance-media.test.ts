...
import { handleArtifactHub } from "@amaze/coding-agent/web/scrapers/artifacthub";
import { handleCoinGecko } from "@amaze/coding-agent/web/scrapers/coingecko";
import { handleDiscogs } from "@amaze/coding-agent/web/scrapers/discogs";
