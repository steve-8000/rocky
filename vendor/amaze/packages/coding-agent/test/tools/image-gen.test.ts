...
import type { CustomToolContext } from "@amaze/coding-agent/extensibility/custom-tools";
import type { ReadonlySessionManager } from "@amaze/coding-agent/session/session-manager";
import { imageGenTool, setPreferredImageProvider } from "@amaze/coding-agent/tools/image-gen";
