...
import { createLspWritethrough } from "@amaze/coding-agent/lsp";
import * as lspClient from "@amaze/coding-agent/lsp/client";
import * as lspConfig from "@amaze/coding-agent/lsp/config";
import type { Diagnostic, LspClient, ServerConfig } from "@amaze/coding-agent/lsp/types";
import { fileToUri } from "@amaze/coding-agent/lsp/utils";
import { type ptree, TempDir } from "@amaze/utils";
...
describe("LSP diagnostics freshness", () => {
	...
	beforeEach(() => {
		tempDir = TempDir.createSync("@amaze-lsp-freshness-");
	});
