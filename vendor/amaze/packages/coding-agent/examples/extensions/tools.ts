 ...
 */
import type { ExtensionAPI, ExtensionContext } from "@amaze/coding-agent";
import { getSettingsListTheme } from "@amaze/coding-agent";
import { Container, type SettingItem, SettingsList } from "@amaze/tui";
