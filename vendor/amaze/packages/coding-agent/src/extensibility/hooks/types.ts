import type { ImageContent, Message, Model, TextContent } from "@amaze/ai";
import type { Component, TUI } from "@amaze/tui";
...
export interface HookContext {
	...
	cwd: string;
	/** Session manager (read-only) - use pi.sendMessage()/amaze.appendEntry() for writes */
