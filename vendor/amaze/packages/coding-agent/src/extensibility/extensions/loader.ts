...
import type { ImageContent, Model, TextContent } from "@amaze/ai";
import type { KeyId } from "@amaze/tui";
import { hasFsCode, isEacces, isEnoent, logger } from "@amaze/utils";
...
class ConcreteExtensionAPI implements ExtensionAPI, IExtensionRuntime {
	...
	constructor(
		public readonly pi: typeof import("@amaze/coding-agent"),
	...
	registerTool<TParams extends import("@amaze/ai").TSchema = import("@amaze/ai").TSchema, TDetails = unknown>(
...
async function loadExtension(
	...
	try {
		...
		const api = new ConcreteExtensionAPI(await import("@amaze/coding-agent"), extension, runtime, cwd, eventBus);
		await factory(api);
