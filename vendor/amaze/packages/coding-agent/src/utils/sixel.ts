import { $env, $flag } from "@amaze/utils";
 ...
 * - AMAZE_FORCE_IMAGE_PROTOCOL=sixel
 * - AMAZE_ALLOW_SIXEL_PASSTHROUGH=1
 */
export function isSixelPassthroughEnabled(): boolean {
	const forcedProtocol = $env.AMAZE_FORCE_IMAGE_PROTOCOL?.trim().toLowerCase();
	return forcedProtocol === "sixel" && $flag("AMAZE_ALLOW_SIXEL_PASSTHROUGH");
}
