    (function() {
      ...
      function renderTodoResult(toolName, args, result, ctx) {
        let html = toolHead(toolName);
      ...
      function renderTodoWrite(name, args, result, ctx) {
        return renderTodoResult('todo_write', args, result, ctx);
      }
      function renderTodoRead(name, args, result, ctx) {
        return renderTodoResult('todo_read', args, result, ctx);
      }
