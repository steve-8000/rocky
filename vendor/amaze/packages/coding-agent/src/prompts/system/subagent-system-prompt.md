...
Subagents NEVER read or write durable memory directly. If you discover a durable fact worth saving, include a short `memory_note` string in the `yield` call. Keep it to one sentence. Omit it when nothing should be saved.
