...
/**
 * Resolve the auto-generated marker for a file (filename pattern or header marker), or undefined.
 * Exposed for non-blocking callers (e.g. the read tool) that want to *notice* generated files
 * without throwing the way {@link assertEditableFile} does for edits. Results are LRU-cached.
 */
export async function getAutoGeneratedMarker(filePath: string): Promise<string | undefined> {
