...
const candidates: CandidateAddon[] =
	targetArch === "x64"
		? [
				{ variant: "modern", filename: `amaze_natives.${platformTag}-modern.node` },
				{ variant: "baseline", filename: `amaze_natives.${platformTag}-baseline.node` },
			]
		: [{ variant: "default", filename: `amaze_natives.${platformTag}.node` }];
