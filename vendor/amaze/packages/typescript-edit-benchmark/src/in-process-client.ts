 ...
 */
import type { AgentEvent, AgentMessage, ResolvedThinkingLevel, ThinkingLevel } from "@amaze/agent-core";
import type { Model } from "@amaze/ai";
import type { AgentSession, AgentSessionEvent, AuthStorage, SessionStats } from "@amaze/coding-agent";
import {
...
export async function discoverSharedInfra(options: DiscoverSharedInfraOptions = {}): Promise<SharedInfra> {
	const { ModelRegistry: MR } = await import("@amaze/coding-agent");
