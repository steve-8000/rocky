...
import { buildOpenAiNativeHistory, requestOpenAiRemoteCompaction } from "@amaze/agent-core/compaction/openai";
import type { AssistantMessage, Model, ToolResultMessage } from "@amaze/ai/types";
