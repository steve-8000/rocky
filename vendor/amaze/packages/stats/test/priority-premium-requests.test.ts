...
import { getAgentDir, getSessionsDir, getStatsDbPath, setAgentDir, TempDir } from "@amaze/utils";
...
const originalConfigDir = process.env.AMAZE_CONFIG_DIR;
...
beforeEach(() => {
	...
	process.env.AMAZE_CONFIG_DIR = configDir;
