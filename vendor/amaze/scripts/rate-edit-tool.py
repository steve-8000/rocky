...
from amaze_rpc import (  # noqa: E402
    AgentEndEvent,
    AutoRetryEndEvent,
    AutoRetryStartEvent,
    ExtensionUiRequest,
...
def resolve_amaze_bin(raw: str | None) -> str:
    ...
    if not found:
        raise SystemExit("Could not find `amaze` on PATH. Set --amaze-bin or AMAZE_BIN.")
    return found
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--amaze-bin", default=os.environ.get("AMAZE_BIN"))
