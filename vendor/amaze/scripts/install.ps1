# AMAZE Coding Agent Installer for Windows
# Usage: irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1 | iex
#
# Or with options:
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1))) -Source
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1))) -Binary
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1))) -Source -Ref v3.20.1
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1))) -Source -Ref main
#   & ([scriptblock]::Create((irm https://raw.githubusercontent.com/can1357/amaze/main/scripts/install.ps1))) -Binary -Ref v3.20.1
...
$InstallDir = if ($env:AMAZE_INSTALL_DIR) { $env:AMAZE_INSTALL_DIR } else { "$env:LOCALAPPDATA\amaze" }
...
function Configure-BashShell {
    try {
        ...
        if ($bashPath) {
            ...
            Write-Host "  AMAZE requires a bash shell on Windows. Options:" -ForegroundColor Yellow
