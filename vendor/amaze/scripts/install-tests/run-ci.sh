...
smoke_cli() {
	...
	XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$amaze_bin" --version
	XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$amaze_bin" --help >/dev/null
	XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$amaze_bin" stats --summary >/dev/null
	...
	XDG_DATA_HOME="$runtime_dir/xdg" HOME="$runtime_dir/home" "$amaze_bin" --smoke-test
}
...
utils_tgz="$(find_tarball "$TARBALL_DIR"/amaze-utils-*.tgz)"
natives_tgz="$(find_tarball "$TARBALL_DIR"/amaze-natives-*.tgz)"
ai_tgz="$(find_tarball "$TARBALL_DIR"/amaze-ai-*.tgz)"
agent_tgz="$(find_tarball "$TARBALL_DIR"/amaze-agent-core-*.tgz)"
tui_tgz="$(find_tarball "$TARBALL_DIR"/amaze-tui-*.tgz)"
stats_tgz="$(find_tarball "$TARBALL_DIR"/amaze-amaze-stats-*.tgz)"
coding_agent_tgz="$(find_tarball "$TARBALL_DIR"/amaze-coding-agent-*.tgz)"
...
(
	...
	node -e "
		...
		pkg.overrides = {
			'@amaze/utils': '$utils_tgz',
			'@amaze/natives': '$natives_tgz',
			'@amaze/ai': '$ai_tgz',
			'@amaze/agent-core': '$agent_tgz',
			'@amaze/tui': '$tui_tgz',
			'@amaze/stats': '$stats_tgz',
			'@amaze/coding-agent': '$coding_agent_tgz'
		};
