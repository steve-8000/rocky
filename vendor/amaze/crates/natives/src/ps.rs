...
//!
//! The platform-specific implementation lives in [`amaze_shell::process`]; this
...
use amaze_shell::process::{self as core_process, ProcessStatus as CoreProcessStatus};
pub use amaze_shell::process::{KILL_SIGNAL, TERM_SIGNAL, TerminationTargets, kill_process_group};
use napi::{
	Env, Result,
