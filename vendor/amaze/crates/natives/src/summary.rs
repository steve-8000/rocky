...
impl From<amaze_ast::summary::SummarySegment> for SummarySegment {
	fn from(value: amaze_ast::summary::SummarySegment) -> Self {
		Self {
			kind: value.kind,
...
impl From<amaze_ast::summary::SummaryResult> for SummaryResult {
	fn from(value: amaze_ast::summary::SummaryResult) -> Self {
		Self {
...
pub fn summarize_code(options: SummaryOptions) -> Result<SummaryResult> {
	amaze_ast::summary::summarize_code(amaze_ast::summary::SummaryOptions {
		code: options.code,
		lang: options.lang,
		path: options.path,
