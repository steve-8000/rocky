...
//! widening that crate's public surface (matches `rocky-agents::clock`).

use time::format_description::well_known::Rfc3339;
use time::OffsetDateTime;

/// Current UTC time as an ISO8601 string with millisecond precision and a
/// trailing `Z`, e.g. `2026-06-11T23:14:49.406Z`. Matches `new Date().toISOString()`.
...
/// matching `Date#toISOString()`. Copied locally per the task brief
/// (`rocky-store` is not edited).
