...
Rocky is minimal, spacious, quiet, confident. Whitespace is deliberate. Nothing crowds, nothing decorates, nothing apologizes. A row, a label, a control. That is the bar.
...
Sentence case. "Pair a device", "Danger zone", "Restart daemon", "Inject Rocky tools", "No sessions yet", "Load more". Proper nouns retain casing — Rocky, Beta, Stable, Local. Title case is wrong.
