...
1. Rocky starts from a copied `ROCKY_HOME` containing 4,851 agent records.
2. Clients ask for provider snapshots for three cwd scopes at almost the same time:
   - `/Users/moboudra`
   - `/Users/moboudra/dev/rocky`
...
5. After OpenCode was listening, Rocky issued six OpenCode HTTP calls concurrently.
...
```text
Cold OpenCode server startup + three concurrent cwd snapshots + large OpenCode /provider responses + daemon startup git contention causes client.provider.list() to complete after Rocky's 30s snapshot budget.
```

More precise wording: the contention is machine-level process/CPU/filesystem contention created by daemon startup work, especially git work. It is not proven to be an OpenCode internal lock or a Rocky-only event-loop issue. A daemon-free repro with only OpenCode plus an external git storm slowed the same six OpenCode calls from about 1s to about 30s total.
...
I later reran a normal dev-daemon startup against a fresh copy of the same Rocky home metadata and drove the app startup request path:
...
```text
ROCKY_HOME=/var/folders/xl/kkk9drfd3ms_t8x7rmy4z6900000gn/T/rocky-devseed.Wms6pi
ROCKY_LISTEN=127.0.0.1:51116
ROCKY_LOG_LEVEL=trace
```
...
- workspaces
- active agents
- provider snapshots for home, rocky, and blankpage/editor
...
18:14:41.687 /Users/moboudra/dev/rocky opencode error:
...
18:14:10.787 opencode availability start for /Users/moboudra/dev/rocky
18:14:10.800 opencode availability start for /Users/moboudra/dev/blankpage/editor

18:14:11.363 rocky availability complete: 576ms
...
```text
18:14:19.931 GET /provider directory=/Users/moboudra/dev/rocky
18:14:19.931 GET /agent    directory=/Users/moboudra/dev/rocky
...
| `/Users/moboudra/dev/rocky`            | workspace-scoped provider snapshot for the Rocky workspace | `client.provider.list()` -> `/provider` | `client.app.agents()` -> `/agent` |
...
| `/agent`    | `/Users/moboudra/dev/rocky`     | 6.681s                |
| `/provider` | `/Users/moboudra/dev/rocky`     | 8.192s                |
...
18:14:29.813 /agent rocky complete, total app.agents duration 9883ms
...
18:14:41.687 rocky snapshot outer 30s timeout fires
...
18:14:43.839 /provider rocky completes, provider.list duration 23911ms, total listModels 32476ms
```

The useful `/provider` results arrived about 1.9s-2.2s after the snapshot manager had already marked home and rocky as failed.
...
/Users/moboudra/dev/rocky refresh:
  total: 1675ms
  status: ready
  models: 409
  modes: 5
...
GET /provider?directory=/Users/moboudra/dev/rocky
GET /agent?directory=/Users/moboudra/dev/rocky
...
```text
/provider /Users/moboudra/dev/rocky: 1270ms total
...
I then ran the same OpenCode-only six-call test while an external shell spawned repeated git commands across the same real workspaces/worktrees. This did not use the Rocky daemon.
...
| `/provider` | `/Users/moboudra/dev/rocky`            | 13220ms |
| `/agent`    | `/Users/moboudra/dev/rocky`            | 13147ms |
...
| Count | Cwd                                                                                   |
| ----: | ------------------------------------------------------------------------------------- |
|    44 | `/Users/moboudra/.rocky/worktrees/1luy0po7/merry-ladybug`                             |
|    44 | `/Users/moboudra/.rocky/worktrees/1luy0po7/hopeful-eel`                               |
|    44 | `/Users/moboudra/.rocky/worktrees/1luy0po7/fix-compaction-cancel-loading`             |
|    44 | `/Users/moboudra/.rocky/worktrees/1luy0po7/fix-archive-worktree-session-history`      |
|    44 | `/Users/moboudra/.rocky/worktrees/0vpo9h4b/breezy-toad`                               |
|    36 | `/Users/moboudra/.rocky/worktrees/steering-policy-refactor-detached`                  |
|    36 | `/Users/moboudra/.rocky/worktrees/1luy0po7/integration-session-mcp-command-stack`     |
|    36 | `/Users/moboudra/.rocky/worktrees/1luy0po7/fix-provider-diagnostic-binary-resolution` |
|    36 | `/Users/moboudra/.rocky/worktrees/1luy0po7/feat-voice-runtime-on-demand`              |
|    36 | `/Users/moboudra/.rocky/worktrees/1luy0po7/feat-find-in-pane`                         |
|    36 | `/Users/moboudra/.rocky/worktrees/1luy0po7/epic-rocky-client-sdk`                     |
|    24 | `/Users/moboudra/dev/rocky`                                                           |
|    24 | `/Users/moboudra/dev/blankpage/editor`                                                |
|    24 | `/Users/moboudra/dev/faro/main`                                                       |
|    24 | `/Users/moboudra/dev/konbert/web`                                                     |
|    24 | `/Users/moboudra/dev/rocky-cloud`                                                     |
...
The original startup showed the same home and rocky outer timeout shape:

```text
16:04:22.466 /Users/moboudra/dev/rocky:
  Timed out refreshing OpenCode after 30000ms
