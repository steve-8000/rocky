...
import type { RockyOpenAIConfig, RockySpeechConfig } from "../bootstrap.js";
...
function buildFeatureProviderInputs(params: {
  ...
  const voiceModeEnabled = resolveOptionalBooleanFlag(
    firstSpeechDefinedValue<string | boolean>([
      params.env.ROCKY_VOICE_MODE_ENABLED,
  ...
  return {
    ...
    voiceTurnDetection: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.ROCKY_VOICE_TURN_DETECTION_PROVIDER,
    ...
    voiceStt: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.ROCKY_VOICE_STT_PROVIDER,
    ...
    voiceTts: {
      configuredValue: firstSpeechDefinedValue<string>([
        params.env.ROCKY_VOICE_TTS_PROVIDER,
...
export function resolveSpeechConfig(params: {
  ...
  openai: RockyOpenAIConfig | undefined;
