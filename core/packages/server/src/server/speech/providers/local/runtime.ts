...
import type { RockySpeechConfig } from "../../../bootstrap.js";
...
function resolveConfiguredLocalModels(speechConfig: RockySpeechConfig | null): ResolvedLocalModels {
  return {
...
export function getLocalSpeechAvailability(
  speechConfig: RockySpeechConfig | null,
