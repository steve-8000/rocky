const VOICE_PROMPT_BLOCK_START = "<rocky_voice_mode>";
const VOICE_PROMPT_BLOCK_END = "</rocky_voice_mode>";

const VOICE_AGENT_SYSTEM_INSTRUCTION = [
  "Rocky voice mode is now on.",
  "You are the Rocky voice assistant.",
...
const VOICE_AGENT_DISABLED_INSTRUCTION = [
  "Rocky voice mode is now off.",
  "Ignore any earlier Rocky voice mode instructions in this thread.",
].join(" ");
