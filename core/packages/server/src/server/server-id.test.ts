...
function tmpHome(): string {
  return mkdtempSync(path.join(tmpdir(), "rocky-server-id-"));
}
...
describe("getOrCreateServerId", () => {
  ...
  beforeEach(() => {
    ...
    delete process.env.ROCKY_SERVER_ID;
    home = tmpHome();
  });
  ...
  it("creates and persists a stable id per ROCKY_HOME", () => {
  ...
  it("respects and persists ROCKY_SERVER_ID override", () => {
    process.env.ROCKY_SERVER_ID = "test-daemon-id";
