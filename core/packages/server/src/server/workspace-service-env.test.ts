...
describe("buildWorkspaceServiceEnv", () => {
  ...
  it("builds default branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      ROCKY_PORT: "5173",
      ROCKY_URL: "http://daemon--rocky.localhost:7767",
      ROCKY_SERVICE_DAEMON_PORT: "5173",
      ROCKY_SERVICE_DAEMON_URL: "http://daemon--rocky.localhost:7767",
    });
  });
  ...
  it("builds feature branch self and service URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      ROCKY_PORT: "5173",
      ROCKY_URL: "http://daemon--feature-x--rocky.localhost:7767",
      ROCKY_SERVICE_DAEMON_PORT: "5173",
      ROCKY_SERVICE_DAEMON_URL: "http://daemon--feature-x--rocky.localhost:7767",
    });
  });

  it("omits PORT while keeping ROCKY_PORT", () => {
    ...
    expect(env.ROCKY_PORT).toBe("5173");
  ...
  it("adds peer service ports and URLs", () => {
    expect(
      ...
      HOST: "127.0.0.1",
      ROCKY_PORT: "5173",
      ROCKY_URL: "http://web--feature-x--rocky.localhost:7767",
      ROCKY_SERVICE_API_PORT: "4000",
      ROCKY_SERVICE_API_URL: "http://api--feature-x--rocky.localhost:7767",
      ROCKY_SERVICE_WEB_PORT: "5173",
      ROCKY_SERVICE_WEB_URL: "http://web--feature-x--rocky.localhost:7767",
    });
  });
  ...
  it("uses public service URLs when a public base URL is configured", () => {
    expect(
      ...
      ROCKY_URL: "https://web--feature-x--rocky.services.example.com",
      ROCKY_SERVICE_API_URL: "https://api--feature-x--rocky.services.example.com",
      ROCKY_SERVICE_WEB_URL: "https://web--feature-x--rocky.services.example.com",
    });
  });
