...
describe("bootstrapWorkspaceRegistries", () => {
  ...
  beforeEach(() => {
    ...
    rockyHome = path.join(tmpDir, ".rocky");
    agentStorage = new AgentStorage(path.join(rockyHome, "agents"), logger);
    projectRegistry = new FileBackedProjectRegistry(
      path.join(rockyHome, "projects", "projects.json"),
      logger,
    );
    workspaceRegistry = new FileBackedWorkspaceRegistry(
      path.join(rockyHome, "projects", "workspaces.json"),
      logger,
    );
