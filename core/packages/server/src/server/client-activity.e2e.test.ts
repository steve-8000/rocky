...
import type { AgentStreamEventPayload } from "@getrocky/protocol/messages";
...
describe("client activity tracking", () => {
  ...
  beforeEach(async () => {
    ...
    daemon = await createTestRockyDaemon({ pushNotificationSender: pushNotifications });
  });
