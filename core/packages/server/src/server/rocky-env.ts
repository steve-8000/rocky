...
export type RockyNodeEnv = "development" | "production" | "test";
...
export function createRockyInternalEnv(baseEnv: NodeJS.ProcessEnv): NodeJS.ProcessEnv {
...
export function resolveRockyNodeEnv(env: NodeJS.ProcessEnv): RockyNodeEnv | undefined {
  const value = env[ROCKY_NODE_ENV];
