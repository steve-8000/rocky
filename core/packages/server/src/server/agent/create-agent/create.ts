...
import type { CreateRockyWorktreeInput } from "../../rocky-worktree-service.js";
import { expandUserPath, resolvePathFromBase } from "../../path-utils.js";
import { toWorktreeRequestError } from "../../worktree-errors.js";
import type { WorkspaceGitService } from "../../workspace-git-service.js";
import type {
  AgentWorktreeSetupContinuation,
  CreateRockyWorktreeSetupContinuationInput,
...
async function resolveMcpCwd(params: {
  ...
  const createdWorktree = await createMcpWorktree({
    ...
    createRockyWorktree: dependencies.createRockyWorktree,
...
interface CreateMcpWorktreeOptions {
  ...
  createRockyWorktree: CreateRockyWorktreeWorkflowFn | undefined;
...
async function createMcpWorktree(
  ...
  try {
    if (!options.createRockyWorktree) {
      throw new Error("Rocky worktree service is not configured");
    }
    return await options.createRockyWorktree(options.input, {
