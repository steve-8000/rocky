...
import {
  ...
  type ArchiveRockyWorktreeCommandDependencies,
  createRockyWorktreeCommand,
  type CreateRockyWorktreeCommandInput,
...
export interface AgentMcpServerOptions {
  ...
  >;
  archiveWorkspaceRecord?: ArchiveRockyWorktreeDependencies["archiveWorkspaceRecord"];
  emitWorkspaceUpdatesForWorkspaceIds?: ArchiveRockyWorktreeDependencies["emitWorkspaceUpdatesForWorkspaceIds"];
  markWorkspaceArchiving?: ArchiveRockyWorktreeDependencies["markWorkspaceArchiving"];
  clearWorkspaceArchiving?: ArchiveRockyWorktreeDependencies["clearWorkspaceArchiving"];
  createRockyWorktree?: CreateRockyWorktreeWorkflowFn;
  rockyHome?: string;
...
export async function createAgentMcpServer(options: AgentMcpServerOptions): Promise<McpServer> {
    ...
    async (args: unknown) => {
      ...
      const {
      ...
      } = await createAgentCommand(
        {
          ...
          terminalManager,
          providerSnapshotManager,
          createRockyWorktree: options.createRockyWorktree,
        },
        {
          kind: "mcp",
  ...
  registerTool(
    "list_worktrees",
    {
      ...
      description: "List Rocky-managed git worktrees for a repository.",
      inputSchema: {
        cwd: z
          .string()
          .optional()
      ...
      const commandResult = await createRockyWorktreeCommand(
        {
          rockyHome: options.rockyHome,
          worktreesRoot: options.worktreesRoot,
          createRockyWorktreeWorkflow: options.createRockyWorktree,
        },
  ...
  registerTool(
    "archive_worktree",
    {
      ...
      description: "Delete a Rocky-managed git worktree.",
      inputSchema: {
        cwd: z
          .string()
          .optional()
    ...
    async ({ cwd, worktreePath, worktreeSlug }) => {
      ...
      const result = await archiveRockyWorktreeCommand(
...
): ArchiveRockyWorktreeCommandDependencies {
  if (!options.github) {
...
): CreateRockyWorktreeCommandInput {
