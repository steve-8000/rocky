...
import { createExternalProcessEnv, type ProcessEnvRecord } from "../rocky-env.js";
export {
...
} from "@getrocky/protocol/provider-config";
import {
  ProviderOverrideSchema,
  ProviderOverridesSchema,
  ProviderRuntimeSettingsSchema,
...
// launched from inside Claude Code (e.g. by a Rocky agent), these leak into
