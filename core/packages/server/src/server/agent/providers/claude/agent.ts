...
export function normalizeClaudeAskUserQuestionUpdatedInput(
  ...
  // Rocky's shared question UI serializes answers by question header, but Claude's
...
class ClaudeAgentSession implements AgentSession {
  ...
  private mapBlocksToTimeline(
    ...
    const items: AgentTimelineItem[] = [];
    // User SDK entries can arrive as multiple text blocks, but Rocky treats them as one message.
