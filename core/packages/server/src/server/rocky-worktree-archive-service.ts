...
import {
  deleteRockyWorktree,
  resolveRockyWorktreeRootForCwd,
  WorktreeTeardownError,
} from "../utils/worktree.js";
import type { TerminalManager } from "../terminal/terminal-manager.js";

export interface ArchiveRockyWorktreeDependencies {
  rockyHome?: string;
...
export async function archiveRockyWorktree(
  dependencies: ArchiveRockyWorktreeDependencies,
  options: {
    targetPath: string;
  ...
  const resolvedWorktree = await resolveRockyWorktreeRootForCwd(targetPath, {
