...
import type { TerminalState } from "@getrocky/protocol/messages";
import type { TerminalInputModeState } from "@getrocky/protocol/terminal-input-mode";
...
declare global {
  interface Window {
    ...
    __ROCKY_TERMINAL_WEBVIEW_RECEIVE__?: (message: InboundMessage) => void;
    __ROCKY_TERMINAL_WEBVIEW_BLUR__?: () => void;
  }
}
...
const TERMINAL_BACKGROUND_CSS_VAR = "--rocky-terminal-background";
...
window.__ROCKY_TERMINAL_WEBVIEW_RECEIVE__ = bridge.receive;
window.__ROCKY_TERMINAL_WEBVIEW_BLUR__ = bridge.blur;
