    ...
    <View style={settingsStyles.card}>
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>Let Rocky start and stop the built-in daemon</Text>
        </View>
        <Switch
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>Daemon keeps running when you quit Rocky</Text>
        </View>
        <Switch
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>
            Runs `rocky daemon status` and shows the output
          </Text>
        </View>
        <Button
          variant="outline"
...
const ADVANCED_DAEMON_SETTINGS_URL = "https://rocky.clab.one/docs/configuration";
