...
const CLI_DOCS_URL = "https://rocky.clab.one/docs/cli";
const SKILLS_DOCS_URL = "https://rocky.clab.one/docs/skills";
const ROW_WITH_BORDER_STYLE = [settingsStyles.row, settingsStyles.rowBorder];
const UNINSTALL_MESSAGE =
  "Removes all Rocky orchestration skills from ~/.agents, ~/.claude, ~/.codex.";
