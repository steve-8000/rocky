...
const RELEASE_DOWNLOAD_BASE_URL = "https://github.com/getrocky/rocky/releases/download";
...
export function buildMacAppleSiliconDownloadUrl(version: string | null | undefined): string | null {
  ...
  return `${RELEASE_DOWNLOAD_BASE_URL}/v${normalizedVersion}/Rocky-${normalizedVersion}-arm64.dmg`;
}
