...
describe("parseAssistantFileLink", () => {
  ...
  it("keeps tilde hrefs as direct home-relative file targets", () => {
    expect(
      parseAssistantFileLink("~/.rocky/plans/file-preview.md", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.rocky/plans/file-preview.md",
      path: "~/.rocky/plans/file-preview.md",
      lineStart: undefined,
      lineEnd: undefined,
    });
    expect(
      parseAssistantFileLink("~/.rocky/plans/file-preview.md:12", {
        workspaceRoot: "/Users/test/project",
      }),
    ).toEqual({
      raw: "~/.rocky/plans/file-preview.md:12",
      path: "~/.rocky/plans/file-preview.md",
      lineStart: 12,
      lineEnd: undefined,
    });
...
describe("normalizeInlinePathTarget", () => {
  ...
  it("keeps tilde paths as home-relative file targets", () => {
    expect(
      normalizeInlinePathTarget("~/.rocky/plans/file-preview.md", "/Users/test/project"),
    ).toEqual({
      directory: "~/.rocky/plans",
      file: "~/.rocky/plans/file-preview.md",
    });
  });
