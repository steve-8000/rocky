...
const STYLE_ID = "rocky-ui-font";
const RULE = "#root *:not([data-pmono]):not([data-pmono] *){font-family:var(--rocky-ui-font);}";
...
export function applyRootUiFont(uiFontStack: string): void {
  ...
  document.documentElement.style.setProperty("--rocky-ui-font", value);
