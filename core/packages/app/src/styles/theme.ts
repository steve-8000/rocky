...
import { darkHighlightColors, lightHighlightColors } from "@getrocky/highlight";
...
// Rocky — warm copper tint (default), matched to the faceted-rock app icon
const rockyDarkColors = buildDarkSemanticColors({
  surface0: "#1B1916",
  surface1: "#211E1B",
  surface2: "#2A2723",
  surface3: "#464340",
  surface4: "#5B5855",
  surfaceDiffEmpty: "#282521",
  surfaceSidebar: "#171513",
  surfaceSidebarHover: "#1f1c19",
  foregroundMuted: "#A5A19C",
  scrollbarHandle: "#757170",
  border: "#2B2823",
  borderAccent: "#353128",
  accent: "#9A5B22",
  accentBright: "#E8A765",
  destructive: "#c64f43", // warm red, hue ~7 — reads as red against the copper tint
});
...
export const darkTheme = buildDarkTheme(rockyDarkColors);
