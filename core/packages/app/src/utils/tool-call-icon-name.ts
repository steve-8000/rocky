import type { ToolCallDetail, ToolCallIconName } from "@getrocky/protocol/agent-types";
import { isRockyToolName } from "@getrocky/protocol/tool-name-normalization";

export type ToolCallIcon = ToolCallIconName | "rocky";
