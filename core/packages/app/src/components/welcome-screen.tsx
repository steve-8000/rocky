...
export function WelcomeScreen({ onHostAdded }: WelcomeScreenProps) {
  ...
  const handleOpenRockySite = useCallback(() => {
    void openExternalUrl("https://rocky.clab.one");
  }, []);
      ...
      >
        <View style={styles.content}>
          ...
          <View style={styles.copyBlock}>
            <Text style={styles.title}>Welcome to Rocky</Text>
            <Text style={styles.subtitle}>Connect your computer to get started</Text>
            {isNative ? (
              <Pressable style={styles.setupLink} onPress={handleOpenRockySite}>
                <Text style={styles.setupLinkText}>rocky.clab.one</Text>
