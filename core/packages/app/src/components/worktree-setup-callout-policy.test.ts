...
describe("shouldShowWorktreeSetupCallout", () => {
  it("shows the callout when rocky config was read and setup commands are missing", () => {
  ...
  it("does not show the callout when reading rocky config fails or has not completed", () => {
