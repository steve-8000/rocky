...
import type { AgentAttachment } from "@getrocky/protocol/messages";
...
import type { AgentCapabilityFlags } from "@getrocky/protocol/agent-types";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "rocky-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "rocky-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--rocky-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--rocky-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return {
    ...
    "--rocky-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--rocky-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  };
}
