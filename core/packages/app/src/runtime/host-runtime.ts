...
import { ConnectionOfferSchema, type ConnectionOffer } from "@getrocky/protocol/connection-offer";
...
const REGISTRY_STORAGE_KEY = "@rocky:daemon-registry";
const LOCALHOST_FALLBACK_ENDPOINT = "localhost:7767";
const DEFAULT_LOCALHOST_BOOTSTRAP_TIMEOUT_MS = 2500;
const E2E_STORAGE_KEY = "@rocky:e2e";
...
const HOST_RUNTIME_STORE_GLOBAL_KEY = "__rockyHostRuntimeStore";
