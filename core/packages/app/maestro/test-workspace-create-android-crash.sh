...
OUT_DIR="/tmp/rocky-workspace-create-android-$(date +%s)"
...
echo "App id: $ROCKY_MAESTRO_APP_ID"
echo "Android direct endpoint: $ROCKY_MAESTRO_DIRECT_ENDPOINT"
echo "Daemon websocket: $ROCKY_MAESTRO_DAEMON_WS_URL"
