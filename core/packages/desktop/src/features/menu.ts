...
import { getWorkspaceActiveRockyBrowserWebContents } from "./browser-webviews.js";
...
function getReloadTargetBrowserWebContents(): Electron.WebContents | null {
  return getWorkspaceActiveRockyBrowserWebContents();
}
...
export function setupApplicationMenu(): void {
  ...
  ipcMain.handle("rocky:menu:showContextMenu", (event, input?: ShowContextMenuInput) => {
