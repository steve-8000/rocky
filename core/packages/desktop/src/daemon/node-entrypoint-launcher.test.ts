...
describe("node-entrypoint-launcher", () => {
  describe("createNodeEntrypointInvocation", () => {
    it("uses the packaged runner when the desktop app is packaged", () => {
      expect(
        createNodeEntrypointInvocation({
          execPath: "/Applications/Rocky.app/Contents/MacOS/Rocky",
          isPackaged: true,
          packagedRunnerPath:
            "/Applications/Rocky.app/Contents/Resources/app.asar/dist/daemon/node-entrypoint-runner.js",
        ...
        command: "/Applications/Rocky.app/Contents/MacOS/Rocky",
        args: [
    ...
    it("uses the entrypoint directly in development", () => {
      expect(
        ...
        args: ["--import", "tsx", "/tmp/rocky-cli.js", "ls"],
        env: {
          PATH: "/usr/bin",
          ELECTRON_RUN_AS_NODE: "1",
        },
