...
describe("runtime-paths", () => {
  beforeEach(() => {
    ...
    setProcessRuntime({
      ...
      resourcesPath: "/Applications/Rocky.app/Contents/Resources",
    });
  });
  ...
  it("uses the macOS Helper executable for packaged daemon node launches", () => {
    expect(resolveNodeExecPath()).toBe(
      "/Applications/Rocky.app/Contents/Frameworks/Rocky Helper.app/Contents/MacOS/Rocky Helper",
    );
  });
});
