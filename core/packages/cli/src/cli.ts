...
import { createMissionCommand } from "./commands/mission/index.js";
...
export function createCli(): Command {
  ...
  program
    .name("rocky")
    .description("Rocky CLI - control your AI coding agents from the command line")
  ...
  addJsonOption(
    program
      .command("status")
      .description('Show local daemon status (alias for "rocky daemon status")'),
  )
  ...
  addJsonOption(
    program
      .command("restart")
      .description('Restart local daemon (alias for "rocky daemon restart")'),
  )
    .option("--home <path>", "Rocky home directory (default: ~/.rocky)")
