...
const existingProject = join(await mkdtemp(join(tmpdir(), "rocky-open-project-")), "project");
...
const previousDesktopCli = process.env.ROCKY_DESKTOP_CLI;
process.env.ROCKY_DESKTOP_CLI = "1";
...
process.env.ROCKY_DESKTOP_CLI = previousDesktopCli;
