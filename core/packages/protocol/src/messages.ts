...
import { MAX_EXPLICIT_AGENT_TITLE_CHARS } from "@getrocky/protocol/agent-title-limits";
...
} from "@getrocky/protocol/schedule/rpc-schemas";
import {
...
} from "@getrocky/protocol/loop/rpc-schemas";
import {
  RockyConfigRawSchema,
  RockyLifecycleCommandRawSchema,
  RockyMetadataGenerationEntrySchema,
  RockyMetadataGenerationSchema,
  ...
  type RockyMetadataGeneration,
  type RockyMetadataGenerationEntry,
  type RockyScriptEntryRaw,
...
export const ReviewAttachmentSchema = z.object({
  ...
  mimeType: z.literal("application/rocky-review"),
  cwd: z.string(),
...
export const WriteProjectConfigRequestMessageSchema = z.object({
  ...
  requestId: z.string(),
  repoRoot: z.string(),
  config: RockyConfigRawSchema,
  expectedRevision: RockyConfigRevisionSchema.nullable(),
});
...
export const StashListRequestSchema = z.object({
  ...
  cwd: z.string(),
  /** If true, only return rocky-created stashes. Default true. */
  rockyOnly: z.boolean().optional(),
  requestId: z.string(),
});
...
export const RockyWorktreeListRequestSchema = z.object({
  type: z.literal("rocky_worktree_list_request"),
  cwd: z.string().optional(),
  repoRoot: z.string().optional(),
  requestId: z.string(),
});

export const RockyWorktreeArchiveRequestSchema = z.object({
  type: z.literal("rocky_worktree_archive_request"),
...
export const CreateRockyWorktreeRequestSchema = z.object({
  type: z.literal("create_rocky_worktree_request"),
  cwd: z.string(),
  projectId: z.string().optional(),
  worktreeSlug: z.string().optional(),
...
export const SessionInboundMessageSchema = z.discriminatedUnion("type", [
  ...
  RockyWorktreeListRequestSchema,
  RockyWorktreeArchiveRequestSchema,
  CreateRockyWorktreeRequestSchema,
...
export const ProjectCheckoutLiteNotGitPayloadSchema = z
  .object({
    ...
    isRockyOwnedWorktree: z.literal(false),
    mainRepoRoot: z.null(),
  })
  .transform((value) => ({
    ...value,
...
export const ProjectCheckoutLiteGitNonRockyPayloadSchema = z
  .object({
    cwd: z.string(),
...
export const ProjectCheckoutLiteGitRockyPayloadSchema = z
  .object({
    cwd: z.string(),
    isGit: z.literal(true),
    currentBranch: z.string().nullable(),
    remoteUrl: z.string().nullable(),
    worktreeRoot: z.string().optional(),
    isRockyOwnedWorktree: z.literal(true),
...
export const ProjectCheckoutLitePayloadSchema = z.union([
  ...
  ProjectCheckoutLiteGitNonRockyPayloadSchema,
  ProjectCheckoutLiteGitRockyPayloadSchema,
]);
...
const WorkspaceGitRuntimePayloadSchema = z
  .object({
    ...
    isRockyOwnedWorktree: z.boolean().optional(),
...
export const ReadProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      repoRoot: z.string(),
      ok: z.literal(true),
      config: RockyConfigRawSchema.nullable(),
      revision: RockyConfigRevisionSchema.nullable(),
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
...
export const WriteProjectConfigResponseMessageSchema = z.object({
  ...
  payload: z.discriminatedUnion("ok", [
    z.object({
      ...
      ok: z.literal(true),
      config: RockyConfigRawSchema,
      revision: RockyConfigRevisionSchema,
    }),
    z.object({
      requestId: z.string(),
      repoRoot: z.string(),
...
const CheckoutStatusGitNonRockySchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isRockyOwnedWorktree: z.literal(false),
  repoRoot: z.string(),
  mainRepoRoot: z.string().nullable().optional().default(null),
...
const CheckoutStatusGitRockySchema = CheckoutStatusCommonSchema.extend({
  isGit: z.literal(true),
  isRockyOwnedWorktree: z.literal(true),
  repoRoot: z.string(),
  mainRepoRoot: z.string(),
...
export const CheckoutStatusResponseSchema = z.object({
  ...
  payload: z.union([
    ...
    CheckoutStatusGitNonRockySchema,
    CheckoutStatusGitRockySchema,
  ]),
});
...
const RockyWorktreeSchema = z.object({
  worktreePath: z.string(),
  createdAt: z.string(),
...
export const RockyWorktreeListResponseSchema = z.object({
  type: z.literal("rocky_worktree_list_response"),
  payload: z.object({
    worktrees: z.array(RockyWorktreeSchema),
    error: CheckoutErrorSchema.nullable(),
    requestId: z.string(),
  }),
});

export const RockyWorktreeArchiveResponseSchema = z.object({
  type: z.literal("rocky_worktree_archive_response"),
  payload: z.object({
    success: z.boolean(),
...
export const CreateRockyWorktreeResponseSchema = z.object({
  type: z.literal("create_rocky_worktree_response"),
  payload: z.object({
    workspace: WorkspaceDescriptorPayloadSchema.nullable(),
    error: z.string().nullable(),
    errorCode: z.string().optional(),
...
export const SessionOutboundMessageSchema = z.discriminatedUnion("type", [
  ...
  RockyWorktreeListResponseSchema,
  RockyWorktreeArchiveResponseSchema,
  CreateRockyWorktreeResponseSchema,
...
export type CreateRockyWorktreeRequest = z.infer<typeof CreateRockyWorktreeRequestSchema>;
...
export type RockyWorktreeListRequest = z.infer<typeof RockyWorktreeListRequestSchema>;
export type RockyWorktreeListResponse = z.infer<typeof RockyWorktreeListResponseSchema>;
export type RockyWorktreeArchiveRequest = z.infer<typeof RockyWorktreeArchiveRequestSchema>;
export type RockyWorktreeArchiveResponse = z.infer<typeof RockyWorktreeArchiveResponseSchema>;
