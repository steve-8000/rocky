...
- **Group the sidebar by status so workspaces waiting on you, ready to review, working, and done are visible at a glance** ([#1317](https://github.com/getrocky/rocky/pull/1317))
- **Start a new workspace from the global sidebar button without choosing a project first** ([#1324](https://github.com/getrocky/rocky/pull/1324))
- **Open the active file directly in your editor, file manager, or GitHub instead of only opening the workspace root** ([#1285](https://github.com/getrocky/rocky/pull/1285) by [@aaronzhongg](https://github.com/aaronzhongg))
- **Automatically archive clean PR workspaces after the PR is merged from host settings** ([#1313](https://github.com/getrocky/rocky/pull/1313))
- **Desktop-managed Rocky skills stay current after installing a newer desktop build** ([#1309](https://github.com/getrocky/rocky/pull/1309))
- **Dart files and Dart code blocks are now syntax-highlighted** ([#1326](https://github.com/getrocky/rocky/pull/1326))

### Improved

- Sidebar workspaces can be marked as read when they are ready to review or failed ([#1317](https://github.com/getrocky/rocky/pull/1317))
- Child agents keep unattended permissions when delegated across providers ([#1315](https://github.com/getrocky/rocky/pull/1315))
- Scheduled agents open with the real prompt and title instead of looking empty ([#1316](https://github.com/getrocky/rocky/pull/1316))
- Git controls prioritize the action that gets a ready branch shipped ([#1316](https://github.com/getrocky/rocky/pull/1316))
- Multiple agent questions are shown one at a time
- OpenCode questions with free-write answers show the typed response in Rocky
...
- **Open workspace services through public service proxy links** ([#1280](https://github.com/getrocky/rocky/pull/1280) by [@mcowger](https://github.com/mcowger))
- **Choose where new worktrees are created** ([#1230](https://github.com/getrocky/rocky/pull/1230) by [@mcowger](https://github.com/mcowger))
- **Desktop windows reopen at the same size and position** ([#1224](https://github.com/getrocky/rocky/pull/1224) by [@everton-dgn](https://github.com/everton-dgn))
...
- Archiving a worktree finishes even if teardown hits an error ([#1260](https://github.com/getrocky/rocky/pull/1260) by [@mcowger](https://github.com/mcowger))
- iOS chat messages render bold, italics, strikethrough, and line breaks correctly ([#1254](https://github.com/getrocky/rocky/pull/1254) by [@outofrange-consulting](https://github.com/outofrange-consulting))
- Right-edge split pane resizing no longer clips ([#1261](https://github.com/getrocky/rocky/pull/1261) by [@everton-dgn](https://github.com/everton-dgn))
...
- **Keep cron schedules aligned to a chosen time zone** ([#1232](https://github.com/getrocky/rocky/pull/1232) by [@damselem](https://github.com/damselem))
...
- macOS displays can idle normally while the desktop app is open ([#1242](https://github.com/getrocky/rocky/pull/1242) by [@fireblue](https://github.com/fireblue))
...
- iOS chat messages no longer hide inline links, URLs, or linked file paths ([#1257](https://github.com/getrocky/rocky/pull/1257) by [@outofrange-consulting](https://github.com/outofrange-consulting))

## 0.1.87 - 2026-05-30

### Added

- Permission prompts from OpenCode subagents now surface in Rocky so you can approve or deny them
...
- Auto-generated agent titles and worktree branch names now use your configured provider fallbacks ([#1219](https://github.com/getrocky/rocky/pull/1219) by [@mcowger](https://github.com/mcowger))
...
- Copy an OpenCode resume command to continue the session outside Rocky
...
- Other agents connecting to Rocky via MCP see the same providers, models, and modes as the app ([#1198](https://github.com/getrocky/rocky/pull/1198))
...
- Allow selecting text in the chat on mobile ([#1153](https://github.com/getrocky/rocky/pull/1153) by [@muzhi1991](https://github.com/muzhi1991))
- Submitting a Pi question no longer looks like a second prompt opened ([#1188](https://github.com/getrocky/rocky/pull/1188) by [@yuruiz](https://github.com/yuruiz))
- Daemon memory leak from unbounded workspace git caches ([#1200](https://github.com/getrocky/rocky/pull/1200))
- Provider diagnostics include the command override binary path ([#1191](https://github.com/getrocky/rocky/pull/1191))
...
- **Rewind chat or files from any user message** ([#1154](https://github.com/getrocky/rocky/pull/1154))
- **See the cumulative cost of an agent session** ([#1163](https://github.com/getrocky/rocky/pull/1163))
- **Drop files onto the terminal to insert their paths** ([#1173](https://github.com/getrocky/rocky/pull/1173))
- **Tap a file path in the terminal to open it in the workspace preview** ([#1174](https://github.com/getrocky/rocky/pull/1174))
- **Approve OpenCode permissions for the whole session** ([#1168](https://github.com/getrocky/rocky/pull/1168))
- **Workspace scripts now appear on the mobile header** ([#1093](https://github.com/getrocky/rocky/pull/1093) by [@ayhanmalkoc](https://github.com/ayhanmalkoc))
...
- Tool activity for read, write, and OpenCode tools renders more consistently ([#1171](https://github.com/getrocky/rocky/pull/1171))
- Compact workspace header actions are tidier
- Settings latency readouts are easier to scan ([#1170](https://github.com/getrocky/rocky/pull/1170))
- Pull request merge is available as soon as GitHub reports the PR is ready ([#1172](https://github.com/getrocky/rocky/pull/1172))

### Fixed

- Mobile slash command autocomplete no longer flickers or mis-layers
- Interrupting an OpenCode agent returns it to idle instead of showing an error ([#1169](https://github.com/getrocky/rocky/pull/1169))
- Provider model selection per workspace is honored ([#1167](https://github.com/getrocky/rocky/pull/1167))
- Draft composer keeps the permission mode you selected ([#1175](https://github.com/getrocky/rocky/pull/1175))
...
- **Rocky can now be installed as a web app from supported browsers** ([#1144](https://github.com/getrocky/rocky/pull/1144))
- **Pi extension dialogs now appear as Rocky permission prompts** ([#1134](https://github.com/getrocky/rocky/pull/1134) by [@yuruiz](https://github.com/yuruiz))
- Added community links and a home button to the sidebar

### Improved

- **Mobile terminals load faster and restore existing output more smoothly** ([#1147](https://github.com/getrocky/rocky/pull/1147))
...
- Worktree archive status no longer reports false unpushed commits ([#1158](https://github.com/getrocky/rocky/pull/1158))
...
- **Pi has been revamped with first-class support**
  ...
  - Pi agents can call Rocky tools when you have the Pi MCP extension installed
...
- **Rename workspaces, terminals, and agent tabs** ([#531](https://github.com/getrocky/rocky/pull/531))
- **DeepSeek TUI in the ACP provider catalog** ([#1096](https://github.com/getrocky/rocky/pull/1096))
- **Kiro CLI in the ACP provider catalog** (by [@huhusmang](https://github.com/huhusmang))
- Catalog providers show their icons in the model picker ([#1098](https://github.com/getrocky/rocky/pull/1098))
- Custom environment variables passed when creating an agent now reach the agent process ([#1112](https://github.com/getrocky/rocky/pull/1112))
- NixOS module supports the public TLS option for self-hosted relays ([#1106](https://github.com/getrocky/rocky/pull/1106) by [@yzx9](https://github.com/yzx9))

### Improved

- **Stale host connections recover automatically without a manual refresh**
- Rocky opens to the workspace you were on last time you used it ([#1101](https://github.com/getrocky/rocky/pull/1101))
...
- Agent file-link tooltips show the full resolved file path ([#1088](https://github.com/getrocky/rocky/pull/1088))
- Workspace git status refreshes less aggressively in the background ([#1102](https://github.com/getrocky/rocky/pull/1102))

### Fixed

- macOS desktop no longer freezes after the display wakes from sleep ([#745](https://github.com/getrocky/rocky/pull/745))
- Windows: Codex picks up the Microsoft Store install correctly ([#1020](https://github.com/getrocky/rocky/pull/1020) by [@32r4](https://github.com/32r4))
- Workspace selection survives a daemon restart ([#1111](https://github.com/getrocky/rocky/pull/1111))
- Cursor agents wait for slash commands to load before listing them ([#1099](https://github.com/getrocky/rocky/pull/1099) by [@chrisbanes](https://github.com/chrisbanes))
...
- Duplicate Claude result text no longer appears in chat ([#1095](https://github.com/getrocky/rocky/pull/1095))
- Dynamic UI styles no longer leak CSS rules across the page ([#1103](https://github.com/getrocky/rocky/pull/1103))
- Relay handshakes reject sessions that try to change encryption keys mid-flight ([#1037](https://github.com/getrocky/rocky/pull/1037) by [@joaosa](https://github.com/joaosa))
...
- **Configurable terminal scrollback** ([#1021](https://github.com/getrocky/rocky/pull/1021) by [@32r4](https://github.com/32r4))
- Assistant file links open at a specific line range when one is included
- Mode icons appear in the agent status menu ([#1059](https://github.com/getrocky/rocky/pull/1059) by [@32r4](https://github.com/32r4))
- MCP exposes schedule update, logs, and run-once tools ([#1032](https://github.com/getrocky/rocky/pull/1032) by [@skevetter](https://github.com/skevetter))
- Self-hosted relays can use a different TLS setting for the public endpoint ([#1045](https://github.com/getrocky/rocky/pull/1045) by [@yzx9](https://github.com/yzx9))

### Improved

- User messages now have a distinct bubble fill for clearer chat hierarchy
- Closing a tab returns to its parent tab
- Diff rows show the full file path on hover ([#1061](https://github.com/getrocky/rocky/pull/1061) by [@Myriad-Dreamin](https://github.com/Myriad-Dreamin))
- The CLI shows the remote daemon host when `ls` cannot connect ([#1043](https://github.com/getrocky/rocky/pull/1043) by [@mturac](https://github.com/mturac))
- Nix install of the daemon is smaller ([#966](https://github.com/getrocky/rocky/pull/966) by [@ixxie](https://github.com/ixxie))
- Nix install honors home-manager profile paths when inheriting the user PATH ([#1040](https://github.com/getrocky/rocky/pull/1040) by [@ixxie](https://github.com/ixxie))
...
- Native diff rows expand correctly ([#940](https://github.com/getrocky/rocky/pull/940) by [@bolasblack](https://github.com/bolasblack))
- Mobile sidebar interactions work correctly on web ([#900](https://github.com/getrocky/rocky/pull/900) by [@nikuscs](https://github.com/nikuscs))
- Mobile web drag gestures fire reliably ([#1048](https://github.com/getrocky/rocky/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Mobile web drag-and-drop activates correctly ([#1048](https://github.com/getrocky/rocky/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- iOS Safari no longer zooms when focusing the composer ([#1048](https://github.com/getrocky/rocky/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Enter behavior in the mobile web composer is consistent ([#1048](https://github.com/getrocky/rocky/pull/1048) by [@nikuscs](https://github.com/nikuscs))
- Composer no longer flickers when resizing with long prompts
- Inline code links in assistant messages open the correct file
- Host switcher popover is wide enough to show host names ([#981](https://github.com/getrocky/rocky/pull/981) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
- Windows: importing existing sessions matches paths correctly ([#1012](https://github.com/getrocky/rocky/pull/1012) by [@kj1534](https://github.com/kj1534))
...
- **Auto Review permission mode for Claude Code and Codex** Agents stop after each assistant turn for review instead of running unattended ([#928](https://github.com/getrocky/rocky/pull/928), [#963](https://github.com/getrocky/rocky/pull/963) by [@bolasblack](https://github.com/bolasblack))
...
- Allow setting fast mode for Rocky subagents ([#909](https://github.com/getrocky/rocky/pull/909), [#910](https://github.com/getrocky/rocky/pull/910) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
...
- New workspace flow honors the currently checked-out branch when branching off ([#909](https://github.com/getrocky/rocky/pull/908) by [@sbtobb](https://github.com/sbtobb))
- OpenCode models from console subscription providers now appear in the model picker ([#917](https://github.com/getrocky/rocky/pull/917) by [@t2o2](https://github.com/t2o2))
- Cursor model picker reflects the models advertised by the Cursor ACP client ([#958](https://github.com/getrocky/rocky/pull/958) by [@chrisbanes](https://github.com/chrisbanes))

### Fixed

- iPad hardware Enter submits the composer ([#919](https://github.com/getrocky/rocky/pull/919) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))
- PR status falls back to a non-checks query for fine-grained GitHub tokens ([#932](https://github.com/getrocky/rocky/pull/932) by [@32r4](https://github.com/32r4))
...
- MCP worktree cache refreshes after create and archive ([#911](https://github.com/getrocky/rocky/pull/911) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))

## 0.1.75 - 2026-05-12

### Added

- Set the speech-to-text language used by dictation and voice mode from settings ([#941](https://github.com/getrocky/rocky/pull/941))

### Fixed

- Codex resume failures now surface as explicit errors instead of leaving the agent silently stuck ([#947](https://github.com/getrocky/rocky/pull/947))
- Custom providers extending Codex now route correctly when they set a custom `OPENAI_BASE_URL` ([#915](https://github.com/getrocky/rocky/pull/915))
- Fixed Copilot's **Allow All** mode (renamed from Autopilot) ([#935](https://github.com/getrocky/rocky/pull/935))
- Desktop: daemon startup no longer fails when a stale PID file is left next to a still-running daemon ([#913](https://github.com/getrocky/rocky/pull/913) by [@biaoma-ty](https://github.com/biaoma-ty))
- iPhone HEIC photos now attach correctly from the image picker ([#934](https://github.com/getrocky/rocky/pull/934))
- Scheduled agents now archive automatically after each run ([#945](https://github.com/getrocky/rocky/pull/945))
- Windows: Codex command summaries trim `pwsh`, `powershell`, or `cmd` wrappers ([#931](https://github.com/getrocky/rocky/pull/931) by [@32r4](https://github.com/32r4))
- iPad: settings sidebar and main sidebar respect the top safe area in wide layouts ([#922](https://github.com/getrocky/rocky/pull/922), [#937](https://github.com/getrocky/rocky/pull/937) by [@kongjiadongyuan](https://github.com/kongjiadongyuan))

## 0.1.74 - 2026-05-11

### Fixed

- **OpenCode agent turns no longer stall** Rocky now follows OpenCode's global event stream, so turns stream reliably without falling back to fragile recovery paths ([#916](https://github.com/getrocky/rocky/pull/916))

## 0.1.73 - 2026-05-10

### Fixed

- **OpenCode agents work again on OpenCode 1.14.42+** ([#895](https://github.com/getrocky/rocky/pull/895), [#902](https://github.com/getrocky/rocky/pull/902), [#904](https://github.com/getrocky/rocky/pull/904) by [@atomlink-ye](https://github.com/atomlink-ye), [@plutofog](https://github.com/plutofog))
- Web: opening a workspace no longer hangs in browsers without `crypto.randomUUID` ([#858](https://github.com/getrocky/rocky/pull/858) by [@cokekitten](https://github.com/cokekitten))
- Codex sub-agent child tool calls now report a final failure state instead of staying as "running" ([#899](https://github.com/getrocky/rocky/pull/899))
- Old relay pairing URLs without an explicit TLS flag work again ([#896](https://github.com/getrocky/rocky/pull/896))
- macOS: the tab-jump shortcut no longer collides with system shortcuts ([#859](https://github.com/getrocky/rocky/pull/859) by [@nikuscs](https://github.com/nikuscs))
- Web: the composer no longer triggers a bottom-sheet keyboard on desktop browsers ([#898](https://github.com/getrocky/rocky/pull/898) by [@nikuscs](https://github.com/nikuscs))
- Windows: git operations no longer flash a console window on each invocation ([#897](https://github.com/getrocky/rocky/pull/897))
- File explorer no longer follows symlinks outside the workspace root ([#847](https://github.com/getrocky/rocky/pull/847) by [@joaosa](https://github.com/joaosa))
- Desktop only opens external URLs via http(s) and mailto schemes ([#845](https://github.com/getrocky/rocky/pull/845) by [@joaosa](https://github.com/joaosa))
- MCP debug request logs now redact request bodies ([#842](https://github.com/getrocky/rocky/pull/842) by [@joaosa](https://github.com/joaosa))

## 0.1.72 - 2026-05-10

### Fixed

- **Codex approval prompts no longer hang** Fixes a regression introduced in 0.1.70 where Codex agents would wait forever on command and file approvals — the prompt never reached the app and the agent stayed stuck in "running" ([#866](https://github.com/getrocky/rocky/pull/866), [#869](https://github.com/getrocky/rocky/pull/869))
- **Windows: daemon no longer crashes when Codex emits non-JSON output** Localized stdout lines from the Codex CLI are now ignored instead of taking down the daemon worker ([#866](https://github.com/getrocky/rocky/pull/866))
- Drag-and-drop images onto the new workspace screen now works ([#850](https://github.com/getrocky/rocky/pull/850))
- Archiving a worktree from the toolbar redirects you immediately instead of leaving you on the dead screen for a beat ([#852](https://github.com/getrocky/rocky/pull/852))
- Pi-backed sessions now shut down cleanly when you close them, releasing extension resources on the Pi side ([#863](https://github.com/getrocky/rocky/pull/863))

## 0.1.71 - 2026-05-09

### Added

- **Import existing Claude, Codex, and OpenCode sessions** into Rocky — pick up a conversation you started in the terminal and keep going from the app, with the full timeline ([#766](https://github.com/getrocky/rocky/pull/766), [#833](https://github.com/getrocky/rocky/pull/833))
- **Subagents now appear in a collapsible section above the composer** so you can jump into agents your main agent spawned ([#532](https://github.com/getrocky/rocky/pull/532))
- Merge a pull request directly from the checkout pane ([#814](https://github.com/getrocky/rocky/pull/814))
- Customize the per-project prompts Rocky uses to auto-generate agent titles, branch names, commit messages, and pull request descriptions ([#836](https://github.com/getrocky/rocky/pull/836))
- Open an empty workspace without typing a prompt first ([#834](https://github.com/getrocky/rocky/pull/834))
- Project settings are now grouped with inline links to the relevant docs ([#837](https://github.com/getrocky/rocky/pull/837))
- Rich context menu on desktop — copy link, copy image, and spellcheck suggestions
- Archiving a Codex-backed agent now archives the underlying native Codex thread too ([#827](https://github.com/getrocky/rocky/pull/827) by [@32r4](https://github.com/32r4))

### Improved

- Opening a workspace auto-focuses the agent that needs your attention ([#828](https://github.com/getrocky/rocky/pull/828))
...
- iOS project picker now submits the typed path ([#831](https://github.com/getrocky/rocky/pull/831))
- System messages and chat mentions routed to multiple agents now reach every recipient consistently ([#830](https://github.com/getrocky/rocky/pull/830))
...
- Local state files (daemon keypair, stored credentials, persisted config) are now readable only by the owning user ([#825](https://github.com/getrocky/rocky/pull/825) by [@joaosa](https://github.com/joaosa))

## 0.1.70 - 2026-05-08

### Breaking

- **Claude agents now require `claude` on your PATH** Install Claude Code globally (`npm install -g @anthropic-ai/claude-code`) before running a Claude agent — Rocky no longer ships a bundled fallback binary. Same posture as Codex and OpenCode, and shrinks the desktop install by ~210 MB per platform
...
- `rocky worktree create` CLI command, with parity to the MCP `create_worktree` tool
- `rocky schedule update` to edit a schedule in place without recreating it
- `rocky schedule run-once` for cron-style triggers, plus `--mode` on `schedule` and `loop`. Background runs now default to unattended mode
- Projects settings now lists workspaces from any remote — GitLab, Gitea, Bitbucket, self-hosted, and SSH-style URLs, not just GitHub ([#681](https://github.com/getrocky/rocky/pull/681) by [@krumpyzoid](https://github.com/krumpyzoid))
...
- **Linux:** Workspace file watchers no longer storm with events on busy working trees, fixing CPU spikes on large repos ([#794](https://github.com/getrocky/rocky/pull/794) by [@312223105](https://github.com/312223105))
- ACP-based agents launch terminal shell commands reliably ([#793](https://github.com/getrocky/rocky/pull/793) by [@ebg1223](https://github.com/ebg1223))
- Checkout shortstat now counts untracked files ([#608](https://github.com/getrocky/rocky/issues/608), [#762](https://github.com/getrocky/rocky/pull/762) by [@somus](https://github.com/somus))
- Relay endpoints on port 443 use TLS automatically ([#774](https://github.com/getrocky/rocky/pull/774) by [@caoer](https://github.com/caoer))
- Desktop CLI passthrough TTY handling — interactive commands now behave correctly when launched from the desktop app
- The CLI honors the `ROCKY_PASSWORD` environment variable for password-protected daemons
...
- Creating an agent in a subdirectory of a registered workspace now runs in that subdirectory instead of jumping up to the parent ([#551](https://github.com/getrocky/rocky/issues/551))
- Non-GitHub project display names are derived from the remote owner/repo instead of the local path
- Desktop IPC wrapped in shared mutation/query hooks, fixing stale state and intermittent failures ([#761](https://github.com/getrocky/rocky/issues/761))
- `rocky schedule create --host` now requires `--cwd` to avoid running schedules in the wrong directory
- `rocky schedule create --every` runs once immediately by default, then on the configured interval
...
- Rocky now recovers automatically when an internal daemon process crashes — your agents stay connected instead of getting stuck and you don't have to restart anything
- Answering an interactive question from a Claude agent now reaches Claude correctly instead of being dropped ([#760](https://github.com/getrocky/rocky/pull/760) by [@somus](https://github.com/somus))
...
- **In-app browser** — open a real web browser in any workspace to test your app ([#670](https://github.com/getrocky/rocky/pull/670) by [@jasonkneen](https://github.com/jasonkneen))
- Inline review comments in the git diff pane. Tap a line number to start a comment ([#530](https://github.com/getrocky/rocky/pull/530))
- Sub-agent activity is now shown for Codex, OpenCode, and Claude ([#672](https://github.com/getrocky/rocky/pull/672), [#658](https://github.com/getrocky/rocky/pull/658) by [@thisisryanswift](https://github.com/thisisryanswift))
- Pull and push your branch in one step from the git actions menu in the changes pane
- Resume existing agent sessions with `rocky import --provider <name> <id>` ([#632](https://github.com/getrocky/rocky/pull/632))
- Password authentication and SSL support for daemon connections ([#635](https://github.com/getrocky/rocky/pull/635))
- Connect to a daemon via relay using a pairing offer URL from the CLI ([#639](https://github.com/getrocky/rocky/pull/639))
- **Windows:** Native ARM64 builds are now available
- Bundled Rocky skills now refresh automatically on desktop app launch
...
- **Apple Silicon Mac:** The desktop update pipeline now publishes manifests atomically, closing a race that could install the Intel build on Apple Silicon Macs and cause 100%+ renderer CPU usage. Affected users will self-heal — electron-updater's Rosetta detection migrates back to arm64 on the next update poll ([#555](https://github.com/getrocky/rocky/issues/555))
- **Linux:** `.deb` and `.rpm` packages now show as `Rocky` in the dock and process list instead of `Rocky.bin`. `--no-sandbox` is now scoped to AppImage only, matching VS Code's sandbox handling ([#602](https://github.com/getrocky/rocky/issues/602))
- **Windows:** Git diff commands no longer break on paths with special characters ([#629](https://github.com/getrocky/rocky/pull/629))
- Cursor CLI and other ACP custom providers launch reliably ([#628](https://github.com/getrocky/rocky/pull/628))
- Daemon stays up when WebSocket clients disconnect mid-stream, and crashes now write a fatal log entry instead of disappearing silently ([#613](https://github.com/getrocky/rocky/pull/613) by [@yuruiz](https://github.com/yuruiz))
- Long agent timelines reconnect cleanly over the relay instead of looping through disconnects while catching up ([#657](https://github.com/getrocky/rocky/pull/657) by [@fireblue](https://github.com/fireblue))
...
- OpenCode mode picker now lists agents available in every mode ([#606](https://github.com/getrocky/rocky/pull/606) by [@thisisryanswift](https://github.com/thisisryanswift))
...
- Archived worktrees stay hidden without flashing back into the list ([#640](https://github.com/getrocky/rocky/pull/640))
...
- `rocky.json` parse errors in setup, teardown, and terminal actions now surface a clear error instead of failing silently
- Diff gutter line numbers were shifted one row out of alignment in some cases on web
- Streamed agent output reconciles cleanly when the timeline hydrates mid-turn ([#663](https://github.com/getrocky/rocky/pull/663))
...
- OpenCode now has a Full Access mode that auto-approves tool calls ([#595](https://github.com/getrocky/rocky/pull/595) by [@tmih06](https://github.com/tmih06))
- OpenCode supports executable slash commands ([#597](https://github.com/getrocky/rocky/pull/597) by [@tmih06](https://github.com/tmih06))

### Improved

- `@`-mention stays responsive on very large projects ([#600](https://github.com/getrocky/rocky/pull/600) by [@yuruiz](https://github.com/yuruiz))

### Fixed

- Workspaces still load when `rocky.json` has a parse error

## 0.1.63 - 2026-04-28

### Added

- Project settings page with a built-in `rocky.json` editor
- Cold start restores your last open workspace
- Tool call badges have a button to open the referenced file directly
- Open the current branch on GitHub from a workspace's open menu ([#583](https://github.com/getrocky/rocky/pull/583) by [@Myriad-Dreamin](https://github.com/Myriad-Dreamin))
- Enable or disable providers from Settings without editing config files
- Rocky prompts you to configure a worktree setup script when one is missing
...
- Voice mode transcription endpoint is configurable for OpenAI-compatible providers ([#570](https://github.com/getrocky/rocky/pull/570) by [@yuruiz](https://github.com/yuruiz))
...
- `rocky.json` setup and teardown accept a single command string, not just an array
...
- `rocky loop run` and `rocky run` now respect the `--provider` and `--model` flags ([#594](https://github.com/getrocky/rocky/pull/594) by [@VincenzoRocchi](https://github.com/VincenzoRocchi))
...
- Installing the rocky CLI from the macOS desktop app now works in packaged builds
...
- `additionalModels` option in provider config lets you add or relabel models without replacing the full list — entries merge with runtime-discovered models (ACP) or your static `models` list. See the [Providers docs](https://rocky.sh/docs/providers)
- New [Providers docs page](https://rocky.sh/docs/providers) covering first-class providers and every custom provider config pattern in one place
...
- Scripts and services per worktree — define named commands in `rocky.json`, and long-running services get supervised with their own ports and nice proxy URLs like `http://web.my-app.localhost:6767`. See the [worktrees guide](https://rocky.sh/docs/worktrees)
...
- `rocky ls` defaults to active agents; pass `-a` to include archived
...
- Codex keeps fast mode after you approve a plan ([#526](https://github.com/getrocky/rocky/pull/526) by [@therainisme](https://github.com/therainisme))
...
- Markdown files render as formatted markdown in the file pane ([#427](https://github.com/getrocky/rocky/pull/427) by [@aaronflorey](https://github.com/aaronflorey))
- Cmd+L (Ctrl+L on Windows/Linux) focuses the agent message input
- Provider models refresh on a freshness TTL; Settings shows last-updated time and any fetch errors ([#426](https://github.com/getrocky/rocky/pull/426))
- `disallowedTools` option in provider config to block specific tools from an agent

### Improved

- Windows: agents launch reliably from npm `.cmd` shims, paths with spaces, and JSON config args — fixes `spawn EINVAL` startup errors ([#454](https://github.com/getrocky/rocky/pull/454))
- OpenCode permission prompts include the requesting tool's context ([#398](https://github.com/getrocky/rocky/pull/398) by [@aaronflorey](https://github.com/aaronflorey))
- OpenCode todo and compaction events render in the timeline ([#429](https://github.com/getrocky/rocky/pull/429) by [@aaronflorey](https://github.com/aaronflorey))
- OpenCode sessions archive cleanly when closed ([#408](https://github.com/getrocky/rocky/pull/408) by [@aaronflorey](https://github.com/aaronflorey))
- OpenCode slash commands recover from SSE timeouts ([#407](https://github.com/getrocky/rocky/pull/407) by [@aaronflorey](https://github.com/aaronflorey))
- Rocky MCP tools work against archived agents, matching the CLI ([#423](https://github.com/getrocky/rocky/pull/423))
- Native scrollbars match the active theme across all web views ([#399](https://github.com/getrocky/rocky/pull/399) by [@ethersh](https://github.com/ethersh))

### Fixed

- Code file previews can be selected and copied on iOS ([#447](https://github.com/getrocky/rocky/pull/447) by [@muzhi1991](https://github.com/muzhi1991))
- File preview no longer shows stale content when reopening the same file ([#411](https://github.com/getrocky/rocky/pull/411) by [@muzhi1991](https://github.com/muzhi1991))
- File explorer reinitialises when the client reconnects after a page refresh ([#442](https://github.com/getrocky/rocky/pull/442) by [@1996fanrui](https://github.com/1996fanrui))
- Generic ACP providers no longer receive duplicated command arguments ([#444](https://github.com/getrocky/rocky/pull/444) by [@edvardchen](https://github.com/edvardchen))
...
- Provider profiles — define custom providers in your Rocky config that appear alongside built-ins. Override a built-in's binary, env, or models, or create entirely new providers. See the [configuration guide](https://github.com/getrocky/rocky/blob/main/docs/custom-providers.md)
- ACP agent support — add any ACP-compatible agent to Rocky with `extends: "acp"` in your provider config. No code changes needed
...
- Rocky tools are no longer injected into agents by default — opt in from Settings when you need agent-to-agent orchestration
- Agent provider and mode are now resolved server-side, so CLI commands like `rocky run` use consistent defaults without client-side lookups
...
- Agents get Rocky tools automatically — every new agent gets access to terminals, schedules, worktrees, and other agents through MCP. Toggle it off in Settings under "Inject Rocky tools"
...
- Agent reload — `rocky agent reload` restarts an agent's underlying process from the CLI
...
- Rocky tool calls in agent timelines show the Rocky logo and human-readable names
...
- Open in editor — jump from any workspace straight into Cursor, VS Code, Zed, or your file manager. Rocky remembers your choice
...
- Desktop app now resolves the user's full login shell environment at startup, fixing tools like `codex`, `node`, `bun`, and `direnv` not being found when Rocky is launched from Finder or Dock. Terminals spawned by Rocky now inherit the same PATH and environment variables as a normal terminal session. Approach adapted from VS Code's battle-tested shell environment resolution
...
- `rocky .` and `rocky <path>` open the desktop app with the given project, similar to `code .`
...
- Desktop Integrations settings — install the Rocky CLI and orchestration skills directly from the app without touching the terminal
...
- Setup hint and rocky.sh link on the mobile welcome screen so new App Store users know what to do next
...
- **Terminal management from the CLI** — new `rocky terminal` command group lets you list, create, and interact with workspace terminals without leaving your terminal
...
- Added `rocky archive` as a top-level alias for `rocky agent archive`
- Added the `ROCKY_AGENT_ID` environment variable for Claude and Codex agents
...
- Fixed `rocky send --no-wait` not taking effect
...
- Improved desktop runtime behavior on Windows by suppressing console windows and defaulting app data to `~/.rocky`
...
- Update the Rocky desktop app and local daemon directly from Settings
...
- `rocky wait` now shows a snapshot of recent agent activity while you wait
