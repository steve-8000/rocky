---
title: Why Rocky?
description: What Rocky is, what it isn't, and how it fits into your workflow.
nav: Why Rocky?
order: 2
---
...
Rocky is a self-hostable platform for running and orchestrating coding agents. It runs the agent CLIs you already use, on the hardware you already have, and gives you a UI, CLI, and API to drive them from anywhere.
...
- Bring your own. Use your Claude subscription, your OpenAI account, your own API keys, a self-hosted endpoint. Rocky doesn't proxy model calls.
...
- MCP server. Agents can drive Rocky themselves: create worktrees, spawn other agents, open terminals, send prompts.

## What it isn't

Not a hosted agent, not an IDE, not a model provider. Rocky runs the CLIs you already use and stays out of the way.
