---
title: Schedules
description: Run Rocky agents on intervals or cron.
nav: Schedules
order: 8
---
...
```bash
rocky schedule ls
rocky schedule inspect <id>
rocky schedule logs <id>
rocky schedule pause <id>
rocky schedule resume <id>
rocky schedule run-once <id>
rocky schedule update <id> --every 10m --max-runs 6
rocky schedule delete <id>
```
...
Agents can create and manage schedules through [Rocky MCP](/docs/mcp).
