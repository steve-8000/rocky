---
title: Rocky MCP
description: Rocky MCP tools injected into agents.
nav: Rocky MCP
order: 7
---
...
Rocky can inject these MCP tools into every new agent it launches. Turn on **Inject Rocky tools** in host settings, or set `daemon.mcp.injectIntoAgents` to `true`.
...
| Tool               | Function                                                                      |
| ------------------ | ----------------------------------------------------------------------------- |
| `list_worktrees`   | List Rocky-managed git worktrees for a repository.                            |
| `create_worktree`  | Create a Rocky-managed git worktree from a branch, base branch, or GitHub PR. |
| `archive_worktree` | Delete a Rocky-managed git worktree.                                          |
