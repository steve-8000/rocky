...
description: Tips for getting the most out of Rocky and mobile-first agent workflows.
nav: Best practices
order: 13
---
...
What I've learned from using Rocky daily. Not rules, just patterns that have worked for me.
...
Don't be shy about running multiple agents. Rocky lets you launch agents in isolated worktrees. Kick one off with voice while walking, then kick off another. They work independently. You get a notification when they're done.
