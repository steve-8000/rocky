...
def _torch():
    ...
    path (``rocky serve``, ``chat``, ``bench``) doesn't import
    ...
    try:
        ...
        raise ImportError(
            "rocky.vllm_platform requires PyTorch when invoked by vLLM. "
            "Install with: pip install 'rocky[vision]' (vision extras "
...
class MLXPlatform:
    ...
    def get_attn_backend_cls(
        ...
        return "rocky.attention.MLXAttentionBackend"
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if hasattr(vllm_config, "parallel_config"):
            ...
            if parallel_config.worker_cls == "auto":
                parallel_config.worker_cls = "rocky.worker.MLXWorker"
    ...
    def get_device_communicator_cls(cls) -> str:
        ...
        return "rocky.distributed.MLXCommunicator"
