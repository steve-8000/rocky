...
from rocky.core.mllm_cache import MLLMPrefixCacheManager
    ...
    def load(self) -> None:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install 'rocky[vision]'"
            )
    ...
    def chat(
        ...
        **kwargs,
        ...
        if cache_hit and cache_entry and cache_entry.kv_cache:
            ...
            # We only use rocky's cache for text-only requests (no images).
            if all_images:
