...
"""
Engine Core for rocky continuous batching.
...
class EngineConfig:
    ...
    # (``rocky.speculative.dflash.server``). No engine-side fields
...
class EngineCore:
    """
    Core engine for rocky inference with continuous batching.
