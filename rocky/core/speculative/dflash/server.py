...
the standard ``rocky.server.app``. It hosts a minimal OpenAI-compatible
...
v1 limitations (documented in README + ``rocky info``):
...
running ``rocky serve qwen3.5-27b-8bit --enable-dflash`` to get a
...
from rocky.core.api.models import (
    AssistantMessage,
...
def _build_app(
    *,
    ...
    async def create_chat_completion(request: ChatCompletionRequest):
        ...
        # trained on; no rocky-side prompt mutation happens here.
        #
