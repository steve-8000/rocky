...
"""
Scheduler for rocky continuous batching.
...
class Scheduler:
    ...
    def __init__(
        ...
        Args:
            ...
            model_config: Optional ``ModelConfig`` from
                ``rocky.model_auto_config``. Used as a capability gate for
    ...
    def _get_request_sampler(self, sampling_params: SamplingParams) -> Any:
        ...
        # without top_k). See ``rocky/_sampler_fast_path.py`` for the
    ...
    def _schedule_waiting(self) -> list[Request]:
        ...
        while self.waiting and len(self.running) < self.config.max_num_seqs:
            ...
            # penalty stays at mlx-lm's default 20 since it's a rocky
